...
/**
 * Класс для построчного чтения файла TODO: Некорректно работает со строками, если длина одной
 * строки в байтах > m_blockSize TODO: Некорректно работает со строками, если длина одной строки в
 * байтах > m_blockSize
 */
