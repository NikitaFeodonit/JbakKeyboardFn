        ...
        extends RelativeLayout
{
    ...
    void init(Context context)
    {
        ...
        m_lp = new LinearLayout.LayoutParams(
    ...
    protected void onFinishInflate()
    {
        ...
        m_rightView.setOnClickListener(
    ...
    void showFullView()
    {
        ...
        m_popupWnd.setTouchInterceptor(
                new OnTouchListener()
                {
...
//                ret-=ServiceJbKbd.inst.m_extraText.getHeight();
            ...
            int place)
    {
        ...
        int ypos = place == AC_PLACE_KEYBOARD
                   ? getContext().getResources().getDisplayMetrics().heightPixels - kbd.getHeight()
                   : 0;
