...
public interface IKbdSettings
{
    ...
    /**
     * @deprecated Ключ, boolean, хранящий настройку вибро при коротком нажатии Заменено на
     * PREF_KEY_VIBRO_SHORT_TYPE
     */
    public static final String PREF_KEY_VIBRO_SHORT_KEY       = "vs";
    /**
     * Ключ, String, тип вибро при коротком нажатии. "0" - нет, "1" - при отпускании, "2" - при
     * нажатии
     */
    ...
    /**
     * Ключ, String, хранящий путь к клавиатуре для выбраного языка в портрете Полный ключ выглядит
     * как PREF_KEY_LANG_KBD+"en".
     */
    public static final String PREF_KEY_LANG_KBD_PORTRAIT       = "kp_path_";
    /**
     * Ключ, String, хранящий путь к клавиатуре для выбраного языка в ландшафте Полный ключ выглядит
     * как PREF_KEY_LANG_KBD+"en".
     */
    public static final String PREF_KEY_LANG_KBD_LANDSCAPE      = "kl_path_";
    /**
     * @deprecated Ключ, int, хранящий индекс текущего скина Уже не юзается. Но его надо выпилить со
     * старых версий
     */
    ...
    /**
     * Ключ, boolean - смена регистра только после символа из PREF_KEY_SENTENCE_ENDS и следующего за
     * ним пробела
     */
    ...
    /**
     * Ключ, String, тип ландшафтного редактора.  Одна из констант PREF_VAL_EDIT_TYPE_ , в видк
     * строки
     */
    public static final String PREF_KEY_LANSCAPE_TYPE           = "landscape_type";
    /**
     * Ключ, String, тип портретного редактора.  Одна из констант PREF_VAL_EDIT_TYPE_ , в видк
     * строки
     */
    ...
    /**
     * Ключ, String, варианты клавиши Shift, строка со значениями:0 - 3-позиц., 1 - normal/shift, 2
     * - normal/capslock
     */
    ...
    /**
     * Ключ, int, использование клавиш громкости для управления курсором. 0:нет, 1:+ влево, -
     * вправо, 2: - влево, + вправо
     */
    ...
    /**
     * Параметр int - ориентация экрана, для которой выбирается раскладка 0- оба типа, 1 - портрет,
     * 2 - ландшафт
     */
