        ...
        extends ContentObserver
{
    ...
    public VibroThread(Context c)
    {
        super(null);
        m_c = c;
        m_c.getContentResolver().registerContentObserver(
                Settings.System.getUriFor(Settings.System.MODE_RINGER), false, this);
    ...
    public void readSettings()
    {
        ...
        try {
            ...
            m_shortVibro = Integer.decode(
                    p.getString(st.PREF_KEY_VIBRO_SHORT_DURATION, JbKbdPreference.DEF_SHORT_VIBRO));
            m_longVibro = Integer.decode(
                    p.getString(st.PREF_KEY_VIBRO_LONG_DURATION, JbKbdPreference.DEF_LONG_VIBRO));
            m_bRepeatVibro = p.getBoolean(st.PREF_KEY_USE_REPEAT_VIBRO, m_bLongVibro);
            m_repeatVibro = Integer.decode(
                    p.getString(st.PREF_KEY_VIBRO_REPEAT_DURATION, JbKbdPreference.DEF_LONG_VIBRO));
