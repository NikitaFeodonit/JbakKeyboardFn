...
// Флаги дизайна (Design Flags)
    ...
    public static       KbdDesign[] arDesign            = {
            ...
            // iPhone
            new KbdDesign(
                    R.string.kbd_design_iphone, 0, Color.BLACK, 0,
                    DF_BOLD | DF_BIG_GAP).setKeysBackground(newIPhoneKey()).setKbdBackground(
                    new BitmapCachedGradBack(0xff9199a3, 0xff444e5c).setCorners(0, 0).setGap(0)),
            // Украина
            new KbdDesign(
                    R.string.kbd_design_ukraine, 0, Color.YELLOW, 0, DF_BOLD).setKeysBackground(
                    new BitmapCachedGradBack(0xff060a6c, 0xff1199af).setGradType(
                            GradBack.GRADIENT_TYPE_SWEEP)).setKbdBackground(
                    new BitmapCachedGradBack(Color.CYAN, Color.YELLOW).setGap(0).setCorners(0, 0)),
            // Шоколад
            new KbdDesign(
                    R.string.kbd_design_chokolate, 0, 0xffffffc0, 0, DF_BOLD).setKeysBackground(
                    new BitmapCachedGradBack(0xff75412b, 0xffc16643).setGradType(
                            GradBack.GRADIENT_TYPE_SWEEP)).setKbdBackground(
                    new BitmapCachedGradBack(0xff400000, GradBack.DEFAULT_COLOR).setGap(0)
                            .setCorners(0, 0)), newHTCDesign(),
            // Рожденный в СССР
            new KbdDesign(R.string.kbd_design_ussr, 0, Color.YELLOW, 0, 0).setKeysBackground(
                    new BitmapCachedGradBack(0xff800000, 0xffc00000).setGradType(
                            GradBack.GRADIENT_TYPE_SWEEP)).setKbdBackground(
                    new BitmapCachedGradBack(0xffff0000, 0xfff31c0d).setCorners(0, 0).setGap(0)),};
//*****************************************************************    
    ...
    static GradBack newIPhoneKey()
    {
        ...
        return new BitmapCachedGradBack(Color.WHITE, 0xffC1C1C1).setGap(6)
                .setShadowColor(GradBack.DEFAULT_COLOR)
                .setStroke(stroke);
    }
    ...
    {
        return new KbdDesign(R.string.kbd_design_htc, 0, 0xff000000, 0, DF_BOLD).setKeysBackground(
                new BitmapCachedGradBack(0xfff8f8f8, 0xffd8d4d8).setGap(3)
                        .setStroke(new BitmapCachedGradBack(0xff605960, 0xff101418).setGap(2)))
                .setKbdBackground(
                        new BitmapCachedGradBack(0xffbdbebd, 0xff706e70).setCorners(0, 0).setGap(0))
                .setFuncKeysDesign(
                        new KbdDesign(0, 0, Color.WHITE, 0, 0).setKeysBackground(
                                new BitmapCachedGradBack(0xff686868, 0xff404040).setGap(3)
                                        .setStroke(
                                                new BitmapCachedGradBack(
                                                        0xff605960, 0xff101418).setGap(2))));
    }
